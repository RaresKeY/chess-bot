...
export RUNPOD_BENCH_ROLLOUT_HORIZON="${RUNPOD_BENCH_ROLLOUT_HORIZON:-8}"
export RUNPOD_BENCH_CLOSENESS_HORIZON="${RUNPOD_BENCH_CLOSENESS_HORIZON:-${RUNPOD_BENCH_ROLLOUT_HORIZON}}"
...
echo "[runpod-bench-10k6] rollout_horizon=${RUNPOD_BENCH_ROLLOUT_HORIZON} closeness_horizon=${RUNPOD_BENCH_CLOSENESS_HORIZON}"
