...
export RUNPOD_FULL_TRAIN_ROLLOUT_HORIZON="${RUNPOD_FULL_TRAIN_ROLLOUT_HORIZON:-8}"
export RUNPOD_FULL_TRAIN_CLOSENESS_HORIZON="${RUNPOD_FULL_TRAIN_CLOSENESS_HORIZON:-${RUNPOD_FULL_TRAIN_ROLLOUT_HORIZON}}"
...
[runpod-full-train-easy] rollout_horizon=${RUNPOD_FULL_TRAIN_ROLLOUT_HORIZON}
[runpod-full-train-easy] closeness_horizon=${RUNPOD_FULL_TRAIN_CLOSENESS_HORIZON}
